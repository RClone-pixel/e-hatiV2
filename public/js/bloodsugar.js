...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function getNormalRange(parameter) {
    switch (parameter) {
      case "GDP":
        return "70 – 109"; // dokter: Normal < 110
      case "GD2PP":
        return "70 – 139";
      case "GDS":
        return "70 – 179";
  ...
  function getAdvice(parameter, level) {
    ...
    if (level === -3)
      return {
        ...
        text: "Hipoglikemia Kritis (< 40). Darurat medis! Otak sangat kekurangan glukosa, risiko pingsan & kejang. Segera hubungi dokter.",
      };
    if (level === -2)
      return {
        icon: "fa-exclamation-triangle",
        text: "Hipoglikemia Berat (40–53). Otak mulai kekurangan glukosa. Segera konsumsi gula cepat dan cari bantuan medis.",
      };
    if (level === -1)
      return {
        icon: "fa-exclamation-circle",
        text: "Hipoglikemia (54–69). Gejala lapar, gemetar, jantung berdebar. Segera konsumsi jus/permen dan hubungi dokter.",
      };
    ...
    if (level === 3)
      return {
        icon: "fa-exclamation-triangle",
        text: "Hiperglikemia Berat (250–599). Gula darah sangat tinggi. Segera konsultasi dokter untuk penanganan intensif.",
      };
    if (level === 4)
      return {
        icon: "fa-exclamation-triangle",
        text: "Krisis Hiperglikemia (>= 600). Kondisi darurat! Risiko koma diabetik. Segera ke UGD rumah sakit.",
      };
    ...
    switch (parameter) {
      case "GDP":
        if (level === 0)
          return {
            ...
            text: "Gula darah puasa normal (70–109). Pertahankan pola makan sehat.",
          };
        if (level === 1)
          return {
            icon: "fa-exclamation-circle",
            text: "Prediabetes (110–125). Kurangi gula, perbanyak aktivitas fisik, dan pantau secara rutin.",
          };
        return {
          icon: "fa-exclamation-triangle",
          text: "Diabetes (126–249). Segera konsultasi dokter dan lakukan pemeriksaan HbA1c.",
        };
      ...
      case "GD2PP":
        if (level === 0)
          return {
            icon: "fa-check-circle",
            text: "Respons gula darah setelah makan baik (70–139). Pertahankan!",
          };
        if (level === 1)
          return {
            icon: "fa-exclamation-circle",
            text: "Prediabetes (140–199). Tubuh mulai lambat mengolah gula. Perlu perubahan pola makan.",
          };
        return {
          icon: "fa-exclamation-triangle",
          text: "Diabetes (200–249). Gula darah pasca makan sangat tinggi. Segera ke dokter.",
        };
      ...
      default:
        if (level === 0)
          return {
            icon: "fa-check-circle",
            text: "Gula darah sewaktu aman (70–179). Tetap jaga pola hidup sehat.",
          };
        if (level === 1)
          return {
            icon: "fa-exclamation-circle",
            text: "Waspada (180–199). GDS tinggi, disarankan tes ulang dalam kondisi puasa untuk diagnosis lebih pasti.",
          };
        return {
          icon: "fa-exclamation-triangle",
          text: "Diabetes (200–249). Kadar gula sangat tinggi. Segera konsultasi ke dokter.",
        };
    }
  }
  ...
  function resetBSUI() {
    ...
    if (bsTitleEl) {
      bsTitleEl.innerHTML =
        'Analisis <span class="text-primary">Gula Darah</span>';
    }
  }
});
