{{-- Detail Modal Tabel Asam Urat --}}
<div class="modal fade" id="AsamTableModal" tabindex="-1" role="dialog" aria-labelledby="asamTableModalLabel"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content ehati-modal-content">
            ...
            <div class="ehati-modal-header p-3 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="modal-title" id="asamTableModalLabel">
                    <i class="fas fa-table mr-2"></i>Tabel Klasifikasi Asam Urat
                </h5>
            ...
            <div class="modal-body p-3 text-center bg-light">
                ...
                <img src="{{ asset('sbadmin2/img/asam-urat.png') }}" alt="Tabel Asam Urat"
