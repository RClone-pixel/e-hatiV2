{{-- Detail Modal Tabel BMI --}}
<div class="modal fade" id="bmiTableModal" tabindex="-1" role="dialog" aria-labelledby="bmiTableModalLabel"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content ehati-modal-content">
            ...
            <div class="ehati-modal-header p-3 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="modal-title" id="bmiTableModalLabel">
                    <i class="fas fa-table mr-2"></i>Tabel Klasifikasi BMI
                </h5>
            ...
            <div class="modal-body p-3 text-center bg-light">
                ...
                <img src="{{ asset('sbadmin2/img/bmi.jpg') }}" alt="Tabel Body Mass Index (BMI)"
