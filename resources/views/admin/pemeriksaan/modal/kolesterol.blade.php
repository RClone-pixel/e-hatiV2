{{-- Detail Modal Tabel Kolesterol --}}
<div class="modal fade" id="KolesterolTableModal" tabindex="-1" role="dialog" aria-labelledby="kolesterolTableModalLabel"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content ehati-modal-content">
            ...
            <div class="ehati-modal-header p-3 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="modal-title" id="kolesterolTableModalLabel">
                    <i class="fas fa-table mr-2"></i>Tabel Klasifikasi Kolesterol
                </h5>
            ...
            <div class="modal-body p-3 text-center bg-light">
                ...
                <img src="{{ asset('sbadmin2/img/kolesterol.jpg') }}" alt="Tabel Kolesterol"
